<section class="filter_map">
	<div class="filter_map__wrapper">
		{{ Form::open(array('action' => 'MapController@point', 'id' => 'filter_map')) }}
			<div class="filter_map__items">
				<div class="filter_map__items_item type change_name">
				...
				<div class="filter_map__items_item finish change_name">
				...
				<div class="filter_map__items_item price">
				...
				<div class="filter_map__items_item area">
				...
				<div class="filter_map__items_item district">
